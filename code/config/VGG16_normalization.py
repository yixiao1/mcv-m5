...
resize_train                 = (260, 260)      # Resize the image during training (Height, Width) or None
resize_valid                 = (260, 260)      # Resize the image during validation
resize_test                  = (260, 260)      # Resize the image during testing
